          ...
          <div class="list-2">
            <div class="overlap-10">
              <div class="overlap-group-wrapper">
                <div class="overlap-group-3"><div class="text-wrapper-12" id="adult">0</div></div>
              </div>
              <div class="div-wrapper-2"><div class="text-wrapper-13 aPlus">+</div></div>
            </div>
            <div class="overlap-11">
              <div class="minus-adult-bt">
                <div class="div-2"></div>
                <div class="text-wrapper-14 aMinus">-</div>
              </div>
              <div class="text-wrapper-15">성인</div>
            </div>
            <div class="overlap-12">
              <div class="teen-count">
                <div class="overlap-group-3"><div class="text-wrapper-12" id="teen">0</div></div>
              </div>
              <div class="plus-teen-bt"><div class="text-wrapper-13 tPlus">+</div></div>
              <div class="minus-senior-bt">
                <div class="div-2"></div>
                <div class="text-wrapper-14 oMinus">-</div>
              </div>
            ...
            <div class="overlap-13">
              <div class="minus-teen-bt">
                <div class="div-2"></div>
                <div class="text-wrapper-14 tMinus">-</div>
              </div>
              <div class="text-wrapper-15">청소년</div>
            </div>
            <div class="overlap-14">
              <div class="overlap-group-wrapper">
                <div class="overlap-group-3"><div class="text-wrapper-12" id="old">0</div></div>
              </div>
              <div class="div-wrapper-2"><div class="text-wrapper-13 oPlus">+</div></div>
            </div>
          </div>

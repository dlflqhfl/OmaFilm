...
<header class="header">
    <div class="navbar">
        ...
        <img class="heading-link" src="../../img/main_img/heading-1-link.png" />
        <div class="m_all"></div>
...
<script>
    ...
    document.querySelector('.m_all').addEventListener('click', function() {
        ...
        if (img.includes('link-3.png')) {
            element.style.backgroundImage = "url('../../img/main_img/cancle.png')";
            document.querySelector('.MenuAll').style.display = 'block';
        }else if (img.includes("cancle.png")) {
            element.style.backgroundImage = "url('../../img/main_img/link-3.png')";

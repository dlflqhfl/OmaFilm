...
<footer class="footer">
    <div class="footer-wrapperr">
        <div class="navbar">
            ...
            <a href="https://www.naver.com" target="_blank" rel="noopener noreferrer">
                <div class="div">인재채용</div>
            </a>
            <a href="https://www.naver.com" target="_blank" rel="noopener noreferrer">
                <div class="text-wrapper-2">사회공헌</div>
            </a>
            <a href="https://www.naver.com/" target="_blank" rel="noopener noreferrer">
                <div class="text-wrapper-3">제휴/광고/부대사업문의</div>
            </a>
            <a href="https://www.naver.com/" target="_blank" rel="noopener noreferrer">
                <div class="item-link">
            ...
            <a href="https://www.naver.com/" target="_blank" rel="noopener noreferrer">
                <div class="div-wrapper">
                    <div class="text-wrapper-4">위치기반서비스 이용약관</div>
                </div>
            </a>
            <a href="https://www.naver.com/" target="_blank" rel="noopener noreferrer">
                <div class="item-link-2">
                    <div class="text-wrapper-5">개인정보처리방침</div>
                </div>
            </a>
            <a href="https://www.naver.com/" target="_blank" rel="noopener noreferrer">
                <div class="item-link-3">
                    <div class="text-wrapper">윤리경영</div>
                </div>
            </a>
        </div>
    </div>

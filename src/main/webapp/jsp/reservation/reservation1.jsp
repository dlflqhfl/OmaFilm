    ...
    <div class="selectseat">
      <div class="overlap-wrapper">
        <div class="overlap">
          ...
          <div class="line-c">
            <div class="text-wrapper-9">C</div>
            <div class="overlap-2">
          ...
          <div class="line-d">
            <div class="text-wrapper-9">D</div>
            <div class="overlap-2">
          ...
          <div class="line-e">
            <div class="text-wrapper-9">E</div>
            <div class="overlap-2">
          ...
          <div class="line-f">
            <div class="text-wrapper-9">F</div>
            <div class="overlap-2">
          ...
          <div class="list-2">
            <div class="overlap-7">
              <div class="overlap-group-wrapper">
                <div class="overlap-group-3"><div class="text-wrapper-11" id="adult">0</div></div>
              </div>
              <div class="div-wrapper-2"><div class="text-wrapper-12 aPlus" >+</div></div>
            </div>
            <div class="minus-adult-bt">
              <div class="div-2"></div>
              <div class="minus-adult-text aMinus">-</div>
            </div>
            <div class="adult-text">성인</div>
            <div class="overlap-8">
              <div class="overlap-group-wrapper">
                <div class="overlap-group-3"><div class="text-wrapper-11" id="teen">0</div></div>
              </div>
              <div class="div-wrapper-2"><div class="text-wrapper-12 tPlus">+</div></div>
              <div class="minus-senior-bt">
                <div class="div-2"></div>
                <div class="text-wrapper-13 oMinus">-</div>
              </div>
            ...
            <div class="overlap-9">
              <div class="minus-teen-bt">
                <div class="div-2"></div>
                <div class="text-wrapper-13 tMinus">-</div>
              </div>
              <div class="teen-text">청소년</div>
            </div>
            <div class="overlap-10">
              <div class="overlap-group-wrapper">
                <div class="overlap-group-3"><div class="text-wrapper-11" id="old">0</div></div>
              </div>
              <div class="div-wrapper-2"><div class="text-wrapper-12 oPlus">+</div></div>
            </div>
          </div>

...
<html>
  ...
  <body>
      ...
      <div class="overlap-wrapper">
        <div class="overlap">
          <div class="div-con-wrap">
            ...
            <div class="heading">자주묻는사항 등록</div>
            <form action="Controller?type=adminAddFrequently" method="post">
            <div class="frame-2">
            <button type="submit" class="text-wrapper-2"
             onclick="return handleSubmit()" value="adminAddFrequently">등록</button></div>
          ...
          <div class="div-sidebar">
            ...
            <div class="list-2">
              ...
              <div class="item-link-2"><a href="Controller?type=adminEvent">이벤트/혜택 관리</a></div>
              <div class="item-link-2"><div class="text-wrapper-9"><a href="Controller?type=adminCpHome">쿠폰관리</a></div></div>
              <div class="item-link-3"><a href="Controller?type=adminNotice">고객센터 관리</a></div>
            </div>
          </div>
        </div>
      </div>
    ...
    function handleSubmit() {
      ...
      function ListClick() {
    	    window.location.href = 'Controller?type=adminFrequently';
    	  }

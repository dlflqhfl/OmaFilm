...
import web.mybatis.dao.MovieDAO;
...
public class MovielistAction implements Action {
	...
	public String execute(HttpServletRequest request, HttpServletResponse response) throws IOException {
				...
				//전체페이지 수를 구하기
				page.setTotalRecode(MovieDAO.getCount());
				
				int cnt = MovieDAO.getCount();
				...
				DailyBoxOfficeVO[] mar = MovieDAO.getList(page.getBegin(), page.getEnd(), null);

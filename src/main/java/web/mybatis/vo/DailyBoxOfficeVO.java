...
public class DailyBoxOfficeVO {
	...
	public DailyBoxOfficeVO() {}

	public DailyBoxOfficeVO(int idx, String boxofficeType, String showRange, String rnum, String rank,
			String rankOldAndNew, String movieCd, String movieNm, String openDt, String salesAmt, String salesShare,
			String salesAcc, String audiCnt, String audiAcc, String scrnCnt, String showCnt) {
		super();
		this.idx = idx;

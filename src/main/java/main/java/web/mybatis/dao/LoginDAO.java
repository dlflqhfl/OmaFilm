    ...
    public static  void handleUserInfo(String accessToken, HttpServletRequest request) {
        ...
        try {
            ...
            if (responseCode == 200) {
                ...
                request.getSession().setAttribute("birth_month", birth_month);
                request.getSession().setAttribute("birth_day", birth_day);
                request.getSession().setAttribute("birth_year", birth_year);
